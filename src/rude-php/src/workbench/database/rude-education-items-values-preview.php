...
class education_items_values_preview
{
	public static function get($id = null)
	{
		$q = new query(RUDE_DATABASE_TABLE_EDUCATION_ITEMS_VALUES_PREVIEW);
	...
	public static function get_by_education_item_ids(array $education_ids)
	{
		...
		$database->query('SELECT * FROM ' . RUDE_DATABASE_TABLE_EDUCATION_ITEMS_VALUES_PREVIEW . ' WHERE item_id IN(' . implode(',', $education_ids) . ')');
	...
	public static function remove($item_id)
	{
		...
		{
			$q = new dquery(RUDE_DATABASE_TABLE_EDUCATION_ITEMS_VALUES_PREVIEW);
	...
	{
//		$q = new uquery(RUDE_DATABASE_TABLE_EDUCATION_ITEMS_VALUES_PREVIEW);
